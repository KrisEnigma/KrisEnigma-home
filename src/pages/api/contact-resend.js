// Marcar este endpoint como server-rendered para que funcione con POST
export const prerender = false;

export async function POST({ request }) {
    try {
        // Importar Resend
        const { Resend } = await import('resend');        // Leer el body del request
        ...
        // Enviar email con diseño simple y profesional
