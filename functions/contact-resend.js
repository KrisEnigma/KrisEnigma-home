...
export async function onRequestPost(context) {
    ...
    try {
        ...
        // Honeypot anti-spam: si el campo website está lleno, es spam
        ...
        // Usar API de Resend directamente con fetch
        console.log('[DEBUG] Enviando email con Resend API...');
        ...
        console.log('[DEBUG] Respuesta de Resend API:', JSON.stringify(responseData));
        
        if (!response.ok) {
            console.error('[DEBUG] Error de Resend:', responseData);
            return new Response(JSON.stringify({
                success: false,
